...
public class CycleMergeTest {
    ...
    public void shouldCorrectlyMergeAButterFly() {
        ...
        Cycle<String> butterfly = cycleOver(cyclicGraph("b", "e", "f")).startingAt(word("b")).merge(
                cycleOver(cyclicGraph("b", "c", "d")).startingAt(word("b")));
    ...
    public static Collection<Object[]> data() {
        ...
        data.add(new Object[]{new String[]{"a", "b", "c"}, new String[]{"b", "d", "e"},
                word("a", "b", "d", "e", "b", "c")});
        data.add(new Object[]{new String[]{"a", "b", "c"}, new String[]{"c", "d", "e"},
                word("a", "b", "c", "d", "e", "c")});
        data.add(new Object[]{new String[]{"a", "b", "c", "d"}, new String[]{"b", "d", "e", "c", "f"},
                word("a", "b", "d", "e", "c", "f", "b", "c", "d")});
        return data;
    }
